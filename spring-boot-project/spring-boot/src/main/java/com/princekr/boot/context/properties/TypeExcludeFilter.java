package com.princekr.boot.context.properties;
 ...
 * <pre class="code">
 * &#064;ComponentScan(exclusionFilters = Filter(type= FilterType.CUSTOM, class = TypeExcludeFilter.class))
 * </pre>
 * <p>
 ...
 * method so that they can be used as part of Spring Test's application context caches.
 * <p>
